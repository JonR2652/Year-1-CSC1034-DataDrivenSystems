...
function sneak() {
    ...
    button1.innerHTML = `Pick up fence cutters`;
...
function cutters() {
    ...
    header.innerHTML = `Guard's Hut`;
    text.innerHTML = `You picked up the fence cutters. However the guard heard a noise and is coming towards you!`;
